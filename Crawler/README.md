...
4. Run `cd ycombinator` change directory.
5. Run `scrapy runspider ycombinator/spiders/yscraper.py -o ./output.jl`. This generates a JSON lines file which you can read with Pandas:
